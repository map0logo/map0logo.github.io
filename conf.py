...
BLOG_TITLE = "map0logo 地図学者"  # (translatable)
...
</a><br />Esta obra está bajo una <a rel="license" href="http://creativecommons.org/licenses/by-sa/4.0/">
...
# If webassets is installed, pre JS and CSS into single files to make
